...
func (f *exchangeEmbedSvc) Update(context.Context, uint64, string, *types.EmbedChannel, *bool, *bool, *bool, *bool, *string, *string, *string, *string) (*types.EmbedChannel, error) {
	return nil, nil
}
