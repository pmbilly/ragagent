...
type EmbedChannelService interface {
	...
	ListByAgent(ctx context.Context, tenantID uint64, agentID string) ([]*types.EmbedChannel, error)
	ListByTenant(ctx context.Context, tenantID uint64) ([]*types.EmbedChannel, error)
	Update(ctx context.Context, tenantID uint64, id string, req *types.EmbedChannel, enabled *bool, showSuggested *bool, allowWebSearch *bool, allowFileUpload *bool, defaultLocale *string, webhookURL *string, webhookSecret *string, launcherIcon *string) (*types.EmbedChannel, error)
	Delete(ctx context.Context, tenantID uint64, id string) error
